...
class TestWbAnalyticsClient:
    ...
    def test_get_sale_report_success(self, wb_client, requests_mock):
    ...
    def test_get_stock_report_429_error(self, wb_client, requests_mock):
    ...
    def test_get_all_stock_reports(self, wb_client):
